                ...
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            <h1>Olá, {{ $nome }}!</h1>
                            <p class="lead">
                                O status da solicitação <strong>foi alterado</strong>
                            </p>
                            <hr>
                            ...
                            <br/>
                            <br/>
                            <a style="font-size: 18px; padding-top: 10px; padding-bottom: 10px;" class="btn btn-primary btn-lg" href="{{ url('/login') }}" title="acessar o painel">ACESSAR O PAINEL</a>
                        </td>
                    </tr>
                </table>
            </td>
