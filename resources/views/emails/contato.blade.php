                ...
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            ...
                            <p class="lead">
                                Esta mensagem foi enviada por <strong>{{ $nome }} - {{ $email }}</strong>
                            </p>
                            <p class="lead">
                            ...
                            <br/>
                            <br/>
                            <a style="font-size: 18px; padding-top: 10px; padding-bottom: 10px;" class="btn btn-primary btn-lg" href="{{ url('/painel/administrador/mensagens') }}" title="acessar o painel">ACESSAR O PAINEL</a>
                        </td>
                    </tr>
                </table>
            </td>
