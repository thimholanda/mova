                ...
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            ...
                            <p class="lead">
                                Este é o status de pagamento de <strong>{{ $user_name }}:</strong>
                            </p>
                            <p class="lead">
                            ...
                            <br/>
                            <br/>
                            <a style="font-size: 18px; padding-top: 10px; padding-bottom: 10px;" class="btn btn-primary btn-lg" href="{{ url('/painel/administrador/solicitacao', ['id' => $solicitacao_id]) }}" title="realizar auditoria">REALIZAR AUDITORIA</a>
                        </td>
                    </tr>
                </table>
            </td>
