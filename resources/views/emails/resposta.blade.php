                ...
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            ...
                            <p>
                                <br>
                                Temos novidades sobre sua solicitação de contato.
                                <br>
                                <br>
                            </p>

                            <p>
                                <strong>Assunto de sua mensagem: </strong>
                            </p>
                            ...
                            <p>
                                <strong>Resposta enviada pelo administrador: </strong><br>
                            </p>
                            ...
                            <p>Ainda tem alguma dúvida ou deseja obter mais informações?</p>
                            <br>
                            <a class="btn-large btn-success" href="http://ziitbusiness.com.br/dev/painel/usuario/contato" title="Enviar nova mensagem">Enviar nova mensagem</a>
                        </td>
                    </tr>
                </table>
            </td>
