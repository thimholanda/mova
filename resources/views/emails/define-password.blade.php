...
<body style="background-color: #F7F7F9;">
    <table align="center" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 650px;">
        <tr>
            <td height="80" style="background-color: #232323;" align="center">
                <img src="http://ziitbusiness.com.br/dev/img/logo-mova.png" alt="Mova">
            </td>
        </tr>
        <tr>
            <td align="center">
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            <h1>Olá, {{ $nome }}!</h1>
                            <p class="lead">
                                Seja bem vindo(a) ao <strong>Mova</strong>
                            </p>
                            <hr>
                            <p>
                                Defina sua senha para começar a utilizar energia renovável em seu negócio.
                            </p>
                            <br/>
                            <br/>
                            <a style="font-size: 18px; padding-top: 10px; padding-bottom: 10px;" class="btn btn-primary btn-lg" href="{{ route('criar-senha', ['token' => $token, 'email' => $email]) }}" title="">DEFINIR MINHA SENHA</a>
                            <br/>
                            <br/>
                            <br/>
                            <p>
                            Você possui uma mensagem não lida na área restrita do Mova
                            </p>
                        </td>
                    </tr>
                </table>
            ...
            <td align="center">
                <table width="100%" cellspacing="0" cellpadding="20" style="background-color: #FFFFFF;">
                    <tr>
                        <td align="center">
                            <hr>
                            <p><small>Copyright © Mova - Todos os direitos reservados</small></p>
                        </td>
                    </tr>
                </table>
            </td>
